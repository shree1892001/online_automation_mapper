...
class MontanaForCORP extends BaseFormHandler {
    ...
    async MontanaForCORP(page,jsonData,payload) {
        try {
            ...
            await this.waitForTimeout(3000)
            const shares_fields = [
                { label: 'Shares Authorized*', value: String(payload.Stock_Details.Number_Of_Shares)
                }
            ];
          ...
          await this.clickButton(page, '.add');
            ...
            const inputData = [
                ...
                { selector: '#field-address2-HknebDwim_MAIL', value: payload.Registered_Agent.Mailing_Information['Address_Line_2']  || " " },
            ...
            await this.fillInputByName(page,'ADDR2', payload.Incorporator_Information.Address['Address_Line_2']  || " ")
